...
class UnitRootTests:
    def __init__(self, df):
        ...
        - df: Pandas DataFrame or Series
            The input DataFrame or Series containing the time series data.
        """
    ...
    def tau_mu(self, critical_value=-2.90, return_values='all'):
        """
    ...
    def phi_1(self, critical_value=5.57, r=2, alpha=0.05, cols_norho=None, return_values='all'):
        """
