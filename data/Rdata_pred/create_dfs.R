...
#
#save(slow, train_xts_s,actual_df, actual_xts_s, file = "favarBBE/data/input_df.RData")
save(df_train, df_test, slow, xts_train, train_xts_s, xts_test, test_s, actual_xts_s, test_set, actual_df, file = "favarBBE/data/initial_df.RData")
